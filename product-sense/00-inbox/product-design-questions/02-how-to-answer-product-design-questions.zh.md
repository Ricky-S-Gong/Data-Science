...
| 大胆设想（Moonshot） | 超越渐进式改进的大胆方案，试图用变革性方式解决根本问题。 |
| 五个为什么（5 Whys） | 连续追问“为什么”的方法，用来挖掘问题更深层的根因。 |
...
- 改进一款产品：“改进 Headspace。”
- 为特定受众设计：“为盲人设计自动售货机。”
- 大胆设想（Moonshot）：Google 常见题型，例如“假设你拥有无限资源，请设计 X。”
...
这类题通常需要 25 分钟，不包括追问环节（follow-up）。面试官常在早期用产品设计题筛掉缺乏基本产品能力的候选人，但它们在现场面试（onsite interview）中也很常见。在标准产品经理面试轮次（PM interview loop）中，你可能会回答好几道。
...
给它一个简短、有记忆点的标语（tagline）。你希望面试官在评分时能记住这句话。
...
### 通过抽象问题回答大胆设想题（Moonshot）

大胆设想（Moonshot）是超越渐进式改进的大胆想法。这类题常见于 Google 面试，但任何设计题都可以通过挖掘根本问题来做出大胆设想感（moonshot feel）。
...
“改进 Instagram 首页标签页（home tab）” 这类问题和设计新产品类似，但你必须考虑：
...
| 机械完成框架步骤 | 答案会像清单（checklist），容易错过洞察。 | 把框架当辅助，而不是必须打勾的清单；每一步都要整体思考。 |
