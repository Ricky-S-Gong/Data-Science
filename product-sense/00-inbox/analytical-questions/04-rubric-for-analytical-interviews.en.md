...
- Data literacy: The ability to understand, analyze, and use data to reach reasonable conclusions.
- Culture fit: Alignment with a company’s working style, communication norms, values, and collaboration habits.
- Critical thinking: The ability to diagnose problems, analyze causes, prioritize, and build an action plan.
- Rubric: A scoring guide that defines what weak, neutral, strong, and very strong performance looks like.

## Core Review

This lesson is about how analytical answers are evaluated. A strong candidate does not merely reach an answer; they show data judgment, prioritization, execution, communication, collaboration, and curiosity.
