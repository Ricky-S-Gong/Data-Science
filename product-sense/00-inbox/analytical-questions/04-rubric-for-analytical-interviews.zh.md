...
- 评分标准：用来定义不同表现等级具体差异的评分表。

## 核心复习

这一课关注的是分析类答案如何被评分。强候选人不只是给出答案，还会展示数据判断、优先级、执行计划、沟通、协作和好奇心。

分析类面试评分标准
![分析类面试评分表](../../assets/images/analytical-questions/rubrics/analytical-rubric.png)
## 核心总结
...
Analytical skills 包括 data literacy，也就是你能否处理和分析数据；以及 comfort with 指标，也就是你能否为特定问题选择并解读合适指标。
...
- Neutral：具备合理知识，但没有选出当前问题的 best-fit 指标。
